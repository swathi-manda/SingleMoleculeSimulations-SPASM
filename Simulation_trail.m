% This code generates simulated single molecule data, using a Markov Chain Model. 
% The data generated by this program can be analyzed using our ensemble averaging program, SPASM. A
